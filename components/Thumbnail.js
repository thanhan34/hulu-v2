...
const Thumbnail = forwardRef(({ result }, ref) => {
    ...
    return (
        <div ref={ref} className="z-50 p-2 transition duration-200 ease-in transform cursor-pointer group sm:hover:scale-105 hover:">
            <Image
                layout="responsive"
                src={`${BASE_URL}${result.backdrop_path || result.posters_path}` || `${BASE_URL}${result.posters_path} `}
                height={1080}
                width={1920}
            />
            <div className="p-2">
